...
describe("Performance_glitch_user korisnik", () => {
  beforeEach(() => {
    cy.visit('/');
    cy.reload();
  })

  it("Uspesna prijava kao performance_glitch_user korisnik", () => {
    cy.get('[data-test="username"]').click().type("performance_glitch_user").should('have.value', 'performance_glitch_user');
  ...
  it("Korisnik performance_glitch_user dodaje najskuplji predmet i uspešno radi checkout", () => {
  ...
  it("Korisnik performance_glitch_user dodaje najjeftiniji predmet i uspešno radi checkout", () => {
    cy.get('[data-test="username"]').click().type("performance_glitch_user");
    cy.get('[data-test="password"]').click().type("secret_sauce");
    cy.get('[data-test="login-button"]').click();
